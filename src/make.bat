...
for /d /r SmartLPM %%d in ("__pycache__") do @if exist "%%d" rd /s /q "%%d"
rd obj /S /Q
md obj
md package
...
call :subdir nknd2info nknd2info
call :subdir SmartLPM SmartLPM
